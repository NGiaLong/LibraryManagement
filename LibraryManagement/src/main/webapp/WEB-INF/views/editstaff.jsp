					...
					<div class="form-group col-sm-6 ">
						...
						<div class="input-group col-sm-8">
							...
							<form:input path="id" type="text" class="form-control"
								id="inputPhone" name="inputPhone" value="${staff.getId() }" disabled="true" />
						</div>
					</div>
					<div class="form-group col-sm-6 ">
						...
						<div class="input-group col-sm-8">
							...
							<form:input path="name" type="text" class="form-control"
								id="inputPhone" name="inputPhone" value="${staff.getName() }" />
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="form-group col-sm-6">
						...
						<div class="input-group date col-sm-8">
							...
							<form:input path="dateOfBirth" type="date" class="form-control"
								id="inputDate" name="inputDate" value="${staff.getDateOfBirth() }" />
						</div>
					</div>
					<div class="form-group col-sm-6">
					...
					<div class="form-group col-sm-6">
						...
						<div class="input-group col-sm-8">
							...
							<form:input path="address" type="text" class="form-control"
								id="inputAdress" name="inputAdress" value="${staff.getAddress() }" />
						</div>
					</div>
				</div>
				<div class="row">
